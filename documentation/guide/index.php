    ...
    <div class="documentation-content">
        <div class="row">
            <div class="col-100">
                ...
                <code style="color: #e31d65">https://leakedpassword.com/api/?p={your-clear-text-password}</code>
                ...
                <code style="color: #25a954">https://leakedpassword.com/api/?s={your-sha1-hashed-password}</code>
                <h2>The response</h2>
