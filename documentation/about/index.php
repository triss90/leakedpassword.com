    ...
    <div class="documentation-content">
        <div class="row">
            <div class="col-100">
                ...
                <p>A sample use case for the API, is testing, during the signup process, whether a user's password has previously been leaked, and take appropriate actions based on the result of the API query.</p>
    ...
    if (data['password']['leak'] == true) {
        ...
        // Continue signup process
                ...
                <p>Since the API draws on data from <a href="haveibeenpwned.com" target="_blank">Have I Been Pwned</a>, the acceptable use guidelines <strong>must</strong> be adhered to.
                    Among the things not allow are:</p>
                <ul>
